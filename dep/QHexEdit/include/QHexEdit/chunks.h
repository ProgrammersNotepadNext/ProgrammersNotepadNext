...
public:
    ...
    auto data(qint64 pos=0, qint64 count=-1, QByteArray *highlighted=0) -> QByteArray;
    ...
    // Search API
    auto indexOf(const QByteArray &ba, qint64 from) -> qint64;
    auto lastIndexOf(const QByteArray &ba, qint64 from)->qint64;
...
private:
    auto getChunkIndex(qint64 absPos) -> int;
